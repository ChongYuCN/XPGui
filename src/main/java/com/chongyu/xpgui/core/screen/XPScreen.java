    ...
    protected void init() {
        ...
        this.buttonsPlus10 =  (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("+"+xpCost1), (button) -> {
            if(xpStates.canPlus(xpCost1)){
                ServerSyncHandle.updateXPBox(this.xpStates, xpCost1);
                ClientSyncHandle.writeC2SXPPacket(this.xpStates, xpCost1);
        ...
        this.buttonsPlus100 =  (ButtonWidget)this.addDrawableChild(ButtonWidget.builder( Text.translatable("+"+xpCost2), (button) -> {
            if(xpStates.canPlus(xpCost2)){
                ServerSyncHandle.updateXPBox(this.xpStates, xpCost2);
                ClientSyncHandle.writeC2SXPPacket(this.xpStates, xpCost2);
        ...
        this.buttonsPlus500 =  (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("+"+xpCost3), (button) -> {
            if(xpStates.canPlus(xpCost3)){
                ServerSyncHandle.updateXPBox(this.xpStates, xpCost3);
                ClientSyncHandle.writeC2SXPPacket(this.xpStates, xpCost3);
        ...
        this.buttonsPlus1000 =  (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("+"+xpCost4), (button) -> {
            if(xpStates.canPlus(xpCost4)){
                ServerSyncHandle.updateXPBox(this.xpStates, xpCost4);
                ClientSyncHandle.writeC2SXPPacket(this.xpStates, xpCost4);
        ...
        this.buttonsPlus5000 =  (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("+"+xpCost5), (button) -> {
            if(xpStates.canPlus(xpCost5)){
                ServerSyncHandle.updateXPBox(this.xpStates, xpCost5);
                ClientSyncHandle.writeC2SXPPacket(this.xpStates, xpCost5);
        ...
        this.buttonsPlus10000 =  (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("+"+xpCost6), (button) -> {
            if(xpStates.canPlus(xpCost6)){
                ServerSyncHandle.updateXPBox(this.xpStates, xpCost6);
                ClientSyncHandle.writeC2SXPPacket(this.xpStates, xpCost6);
...
//        //============================
//        this.buttonsPlus =  (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("全部存入"), (button) -> {
//            if(xpStates.canPlusTotal()){
//                ServerSyncHandle.updateXPBox(this.xpStates, xpStates.getPlayerEntity().totalExperience);
//                ClientSyncHandle.writeC2SXPPacket(this.xpStates,xpStates.getPlayerEntity().totalExperience);
//                disableButtons(buttonsPlus,10);
//            }else {
//                this.buttonsPlus.active  =false;
//            }
//        }).dimensions(this.width/2 - 25, this.scaledHeight / 2 +25, 50, 10).build());
//        this.buttonsOut =  (ButtonWidget)this.addDrawableChild(ButtonWidget.builder(Text.translatable("全部取出"), (button) -> {
//            if(xpStates.canPlus(-xpStates.xp)){
//                ServerSyncHandle.updateXPBox(this.xpStates, -xpStates.xp);
//                ClientSyncHandle.writeC2SXPPacket(this.xpStates, -xpStates.xp);
//                disableButtons(buttonsOut,10);
//            }else {
//                this.buttonsOut.active  =false;
//            }
//        }).dimensions(this.width/2 +40, this.scaledHeight / 2 +25, 50, 10).build());
    }
...
//            }
    ...
    public void render(DrawContext matrices, int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.client.player != null) {
            ...
            InventoryScreen.drawEntity(matrices,(int)(scaledWidth / 2 - 85), (int)(scaledHeight / 2 - 60), (int)(scaledWidth / 2 - 36), (int)(scaledHeight / 2 + 10), 30, 0.0625f, mouseX,mouseY, this.client.player);
...
//            matrices.drawTextWithShadow(this.textRenderer,  Text.translatable("xpgui.info4").append(Text.of(String.valueOf(playerEx))).formatted(Formatting.LIGHT_PURPLE), this.width/2 -25, this.scaledHeight / 2 +40, 16777215);
        }
    }
