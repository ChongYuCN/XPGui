...
public class XPScreen extends Screen {
    ...
    @Override
    protected void init() {
        this.buttonsPlus10 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 - 25, this.scaledHeight / 2 -65, 50, 10, Text.translatable("+"+xpCost1), (button) -> {
        ...
        this.buttonsOut10 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 +40, this.scaledHeight / 2 -65, 50, 10, Text.translatable("-"+xpCost1), (button) -> {
            if(xpStates.canPlus(-xpCost1)){
                PlayerStatsServerPacket.writeS2CXPPacket2(this.xpStates, -xpCost1);
                PlayerStatsClientPacket.writeC2SIncreaseLevelPacket(this.xpStates, -xpCost1);
        ...
        //=================================
        this.buttonsPlus100 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 - 25, this.scaledHeight / 2 -50, 50, 10, Text.translatable("+"+xpCost2), (button) -> {
        ...
        this.buttonsOut100 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 +40, this.scaledHeight / 2 -50, 50, 10, Text.translatable("-"+xpCost2), (button) -> {
            if(xpStates.canPlus(-xpCost2)){
                PlayerStatsServerPacket.writeS2CXPPacket2(this.xpStates, -xpCost2);
                PlayerStatsClientPacket.writeC2SIncreaseLevelPacket(this.xpStates, -xpCost2);
        ...
        //=================================
        this.buttonsPlus500 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 - 25, this.scaledHeight / 2 -35, 50, 10, Text.translatable("+"+xpCost3), (button) -> {
        ...
        this.buttonsOut500 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 +40, this.scaledHeight / 2 -35, 50, 10, Text.translatable("-"+xpCost3), (button) -> {
            if(xpStates.canPlus(-xpCost3)){
                PlayerStatsServerPacket.writeS2CXPPacket2(this.xpStates, -xpCost3);
                PlayerStatsClientPacket.writeC2SIncreaseLevelPacket(this.xpStates, -xpCost3);
        ...
        //=================================
        this.buttonsPlus1000 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 - 25, this.scaledHeight / 2 -20, 50, 10, Text.translatable("+"+xpCost4), (button) -> {
        ...
        this.buttonsOut1000 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 +40, this.scaledHeight / 2 -20, 50, 10, Text.translatable("-"+xpCost4), (button) -> {
            if(xpStates.canPlus(-xpCost4)){
                PlayerStatsServerPacket.writeS2CXPPacket2(this.xpStates, -xpCost4);
                PlayerStatsClientPacket.writeC2SIncreaseLevelPacket(this.xpStates, -xpCost4);
        ...
        //====================================
        this.buttonsPlus5000 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 - 25, this.scaledHeight / 2 -5, 50, 10, Text.translatable("+"+xpCost5), (button) -> {
        ...
        this.buttonsOut5000 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 +40, this.scaledHeight / 2 -5, 50, 10, Text.translatable("-"+xpCost5), (button) -> {
            if(xpStates.canPlus(-xpCost5)){
                PlayerStatsServerPacket.writeS2CXPPacket2(this.xpStates, -xpCost5);
                PlayerStatsClientPacket.writeC2SIncreaseLevelPacket(this.xpStates, -xpCost5);
        ...
        //============================
        this.buttonsPlus10000 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 - 25, this.scaledHeight / 2 +10, 50, 10, Text.translatable("+"+xpCost6), (button) -> {
        ...
        this.buttonsOut10000 =  (ButtonWidget)this.addDrawableChild(new ButtonWidget(this.width/2 +40, this.scaledHeight / 2 +10, 50, 10, Text.translatable("-"+xpCost6), (button) -> {
            if(xpStates.canPlus(-xpCost6)){
                PlayerStatsServerPacket.writeS2CXPPacket2(this.xpStates, -xpCost6);
                PlayerStatsClientPacket.writeC2SIncreaseLevelPacket(this.xpStates, -xpCost6);
...
//            }
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.client.player != null) {
            ...
            InventoryScreen.drawEntity((int)(scaledWidth / 2 - 75), (int)(scaledHeight / 2 - 10),  30, -mouseX, -mouseY, this.client.player);


            drawCenteredText(matrices, this.textRenderer,  xpStates.getPlayerEntity().getName().copy().formatted(Formatting.YELLOW).append(Text.translatable("xpgui.info1")), this.width / 2 + 27, this.scaledHeight / 2 -108, 16777215);
            drawTextWithShadow(matrices, this.textRenderer,  Text.translatable("xpgui.info2").append(Text.of(xpBox+"/"+xpStates.GetMaxXp())).formatted(Formatting.GOLD), this.width/2 -25, this.scaledHeight / 2 -95, 16777215);
            drawTextWithShadow(matrices, this.textRenderer,  Text.translatable("xpgui.info3").formatted(Formatting.GREEN), this.width/2 -25, this.scaledHeight / 2 -80, 16777215);
            drawTextWithShadow(matrices, this.textRenderer,  Text.translatable("xpgui.info4").append(Text.of(String.valueOf(playerEx))).formatted(Formatting.LIGHT_PURPLE), this.width/2 -25, this.scaledHeight / 2 +25, 16777215);
        }
    }
